...
- The coding questions in cs229 were so old that I skipped most of them (I took other hardcore and very practical courses, for example: cs336).
- I wrote down all the whiteboard derivations from the Youtube lectures and the steps of some important exercises on paper.
- If I have time to delve deeper into AI, I will first take a convex optimization course, then cs229m.
...
- Future I will integrate other algorithms (not covered in cs229), and then I will upload it to my ML-notes.
